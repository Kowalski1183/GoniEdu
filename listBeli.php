                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            $getTgl = "SELECT tgl_pemb from pembelian  where  status_pemb = 'Pending' OR status_pemb = 'Dalam Proses' GROUP BY tgl_pemb desc";
                            ...
                            <p class="tgl m-0 text-uppercase text-success text-truncate font-weight-bold"><?php echo $date;?></p>
                                ...
                                $getBeli = "SELECT * from pembelian  where tgl_pemb='".$Tgl['tgl_pemb']."' AND status_pemb = 'Pending' OR tgl_pemb='".$Tgl['tgl_pemb']."' AND status_pemb = 'Dalam Proses' GROUP BY id_pemb ";
                                    ...
                                    <div class="card-box widget-box-two widget-two-custom">
                                        <div class="media">
                                            <div class="wigdet-two-content media-body">
                                                ...
                                                <?php if($Pembelian ['status_pemb']=='Pending'){?>
                                                    <a class="btn btn-primary" href="proceedBeli.php?id_beli=<?php echo $Pembelian['id_pemb'];?>" role="button">Approve</a>
                                                <?php }else{?>
                                                
                                                <a class="btn btn-primary" href="updateBeli.php?id_beli=<?php echo $Pembelian['id_pemb'];?>" role="button">Konfirmasi</a>
                                                <?php }?>
                                                <a class="btn btn-primary" href="batalBeli.php?id_beli=<?php echo $Pembelian['id_pemb'];?>" role="button">Batalkan</a>
                                            </div>
