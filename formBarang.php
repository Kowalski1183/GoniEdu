            ...
            <!-- <div class="content-page"> -->
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- start page title -->
                        <form action="insertBrg.php" method="POST" enctype="multipart/form-data">
                            <!-- HEADER  -->
                            <div class="row">
                                <div class="col-12">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group"  >
                                    ...
                                    <input type="text" class="form-control" name="nama_brg" placeholder="Sabun" required="">
                                </div>
                                <!-- INPUT NOMOR HP KONSUMEN -->
                                <div class="form-group">
                                    <b><label>Harga </label></b>
                                    <input type="text" class="form-control" name="harga_brg" placeholder="1000" required="">
                                </div>
                                <!-- INPUT NOMOR HP KONSUMEN -->
                                <div class="form-group">
                                    <b><label>Jenis Barang</label></b>
                                    <input type="text" class="form-control" name="jenis_brg" placeholder="Alat Mandi" required="">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <b><label>Gambar (optional)</label></b>
