                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            join setor on setor.id_setor = detail_setor.id_setor GROUP BY tgl_setor desc";
                            ...
                            <p class="tgl m-0 text-uppercase text-success text-truncate font-weight-bold"><?php echo $date;?></p>
                                ...
                                join setor on setor.id_setor = detail_setor.id_setor where tgl_setor = '".$Tgl['tgl_setor']."'";
