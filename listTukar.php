                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            $getTgl = "SELECT tgl_tukar from penukaran  where  status = 'Pending' OR status = 'Dalam Proses' GROUP BY tgl_tukar desc";
                            ...
                            <p class="tgl m-0 text-uppercase text-success text-truncate font-weight-bold"><?php echo $date;?></p>
                                ...
                                $getTukar = "SELECT * from penukaran join wallet using(id_wallet) join metode on metode.id_pilih = wallet.id_pilih 
                                where tgl_tukar='".$Tgl['tgl_tukar']."' AND status = 'Pending' OR  tgl_tukar='".$Tgl['tgl_tukar']."' AND status = 'Dalam Proses'";
                                    ...
                                    <div class="card-box widget-box-two widget-two-custom">
                                        <div class="media">
                                            <div class="wigdet-two-content media-body">
                                                ...
                                                <?php if($Penukaran['status']=='Pending'){?>
                                                    <a class="btn btn-primary" href="proceedTukar.php?id_tukar=<?php echo $Penukaran['id_tukar'];?>" role="button">Approve</a>
                                                <?php }else{?>
                                                    <a class="btn btn-primary" href="updateTukar.php?id_tukar=<?php echo $Penukaran['id_tukar'];?>" role="button">Konfirmasi</a>
                                                <?php }?>
                                                    <a class="btn btn-primary" href="batalTukar.php?id_tukar=<?php echo $Penukaran['id_tukar'];?>" role="button">Batalkan</a>
                                            </div>
