                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            $getTgl = "SELECT tgl_jemput from detail_setor join sampah_setor on sampah_setor.id_sampahsetor = detail_setor.id_sampahsetor
                            join setor on setor.id_setor = detail_setor.id_setor where cara_setor = 'Jemput'  AND status = 'Pending' OR cara_setor = 'Jemput'  AND status = 'Dalam Proses' GROUP BY tgl_jemput desc";
                            
                            $resultTgl = mysqli_query($koneksi,$getTgl);
                            while ($Tgl = mysqli_fetch_assoc($resultTgl)){  $date = date("d M Y",strtotime($Tgl['tgl_jemput']));?>
                            ...
                            <p class="tgl m-0 text-uppercase text-success text-truncate font-weight-bold"><?php echo $date;?></p>
                                ...
                                join setor on setor.id_setor = detail_setor.id_setor where cara_setor = 'Jemput'  AND tgl_jemput = '".$Tgl['tgl_jemput']."' AND status = 'Pending' OR cara_setor = 'Jemput'  AND tgl_jemput = '".$Tgl['tgl_jemput']."' AND status = 'Dalam Proses' ";
                                    ...
                                    <div class="card-box widget-box-two widget-two-custom">
                                        <div class="media">
                                            <div class="wigdet-two-content media-body">
                                                ...
                                                <p class="m-0 text-uppercase font-weight-medium text-truncate" >Berat      : <?php echo $Setoran['berat'];?></p>

                                                <p class="m-0 text-uppercase font-weight-medium text-truncate" >Alamat    : <?php echo $Setoran['alamat_setor'];?></p>
                                                ...
                                                <?php if($Setoran ['status']=='Pending'){?>
                                                    <a class="btn btn-primary" href="proceedJemput.php?status=Pending&&id_detail_pickup=<?php echo $Setoran['id_detail_pickup'];?>" role="button">Approve</a>
                                                <?php }else{?>
