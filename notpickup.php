                                    ...
                                    <div class="row">
                                        ...
                                        <?php else : ?>
                                            <div class="col-md-6">
                                                <div class="clearfix pt-4">
                                                <?php 
                                                    $point = "SELECT * FROM konsumen INNER JOIN penukaran ON konsumen.id_ksmn=penukaran.id_ksmn INNER JOIN wallet ON penukaran.id_wallet=wallet.id_wallet WHERE konsumen.id_ksmn ='" . $_SESSION["konsumen"]["id_ksmn"] . "' AND id_tukar = '" . $_GET["tukar"]. "' ";
                                                    $quary = mysqli_query($koneksi, $point);
                                                    $poin = mysqli_fetch_object($quary)?>
                                                        <p><b>TOKEN TUKAR</b> &emsp;&nbsp;&emsp;&emsp;&nbsp;&emsp;&emsp;: &nbsp;<b><?= $poin->token_tukar;  ?></b></p>
                                                        <p><b>No Tujuan&emsp;&emsp;&nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;: &nbsp;</b> <?= $poin->telpon; ?></p>
                                                        <p><b>Berat Total Sampah&emsp;&emsp;&nbsp;&ensp;: &nbsp;</b> <?= $gj['total_berat']; ?> gram</p>
                                                        <p><b>Cara Pengambilan Uang : &nbsp;</b> <?= $poin->wallet; ?></p>
                                                        <p><b>Uang yang didapat&emsp;&emsp;&nbsp;&ensp;: &nbsp;</b>Rp. <?= number_format($poin->nominal); ?></p>
                                                    </div>
                                                </div>
                                            <?php endif; ?>
                                        </div>
