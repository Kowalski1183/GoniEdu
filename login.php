                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="account-box">
                                <div class="account-logo-box">
                                    ...
                                    <h5 class="text-uppercase mb-1 mt-4" align="center">Sign In Nasabah</h5>
                                </div>
                                ...
                                <div class="account-content mt-4">
                                    <form class="form-horizontal" action=""method="POST">
                                        <div class="form-group row">
                                            <div class="col-12">
                                            <a href="loginAdmin.php" class="text-danger float-right text-da"><small>Login as Admin</small></a>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-12">
                                                <a href="recoverypw.php" class="text-muted float-right"><small>Forgot your password?</small></a>
                                    ...
                                    <?php  if(isset($_POST['login'])){
                                            ...
                                            $getPw = "select * from konsumen where email='".$_POST['email']."'";
                                            ...
                                            $rowPw = mysqli_fetch_assoc($resultPw);
                                                ...
                                                $_SESSION['konsumen']=$rowPw;
                                                $_SESSION['login'] = 1;
                                    
                                                if ($_SESSION['login'] == 1) {echo "<script>alert('login berhasil');</script>";
                                                    header("location: dashcus.php");
                                                    exit();
                                                }
